                    ...
                    dashboardBody(
                      ...
                      fluidRow(
                        column(9,
                               ...
                               p("App created by ", tags$a(href = "https://www.cnordenlow.com", 'Christoffer Nordenlöw', target = '_blank'), " in 2021", HTML("&bull;"),
                                 "Find the code on Github:", tags$a(href = "https://github.com/cnordenlow/us-rates-monitor", tags$i(class = 'fa fa-github', style = 'color:#5000a5'), target = '_blank'), style = "font-size: 85%"),
...
server <- function(input, output,session) {
  ...
  datasetInput_dashboard_2 <- reactive({
    ...
    df <- tableForShiny %>%
      ...
      filter(rate != "NA")%>%
      filter(term %in% c('3m10y', '2y10y', '5y30y'))%>%
